...
# Part 1
# def sum (arr)
#     split_arr = arr.map{|ele| ele.split(" ")}
#     down = 0
#     up = 0
#     forward = 0
#     aim = 0

#     split_arr.each do |sub|
#         if sub[0] == "down"
#             down += sub[1].to_i
#             aim  += sub[1].to_i
#         end
